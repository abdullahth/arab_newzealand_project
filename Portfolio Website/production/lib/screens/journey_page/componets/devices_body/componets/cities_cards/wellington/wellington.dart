...
class WelingtonCityCard extends StatefulWidget {
  @override
  _WelingtonCityCardState createState() => _WelingtonCityCardState();
}

class _WelingtonCityCardState extends State<WelingtonCityCard> {
  late bool hover;
  @override
  void initState() {
    hover = false;
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: Assets.welingtonCity.provider,
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Container(
