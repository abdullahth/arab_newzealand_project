...
class CordisHotelCard extends StatefulWidget {
  @override
  _CordisHotelCardState createState() => _CordisHotelCardState();
}

class _CordisHotelCardState extends State<CordisHotelCard> {
  late bool hover;
  @override
  void initState() {
    hover = false;
  ...
  final Hotel hotel = Hotel.hotels[0];
  @override
