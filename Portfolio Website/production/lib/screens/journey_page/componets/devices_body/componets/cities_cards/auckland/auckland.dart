...
class AuckalndCityCard extends StatefulWidget {
  @override
  _AuckalndCityCardState createState() => _AuckalndCityCardState();
}

class _AuckalndCityCardState extends State<AuckalndCityCard> {
  late bool hover;
  @override
  void initState() {
    hover = false;
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: Assets.aucklandCity.provider,
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Container(
