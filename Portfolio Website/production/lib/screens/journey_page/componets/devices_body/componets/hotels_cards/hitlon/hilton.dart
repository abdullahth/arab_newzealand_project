...
class HitlonHotelCard extends StatefulWidget {
  @override
  _HitlonHotelCardState createState() => _HitlonHotelCardState();
}

class _HitlonHotelCardState extends State<HitlonHotelCard> {
  late bool hover;
  @override
  void initState() {
    hover = false;
  ...
  final Hotel hotel = Hotel.hotels[1];
  @override
