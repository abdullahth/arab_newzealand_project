...
class NovotellHotelCard extends StatefulWidget {
  @override
  _NovotellHotelCardState createState() => _NovotellHotelCardState();
}

class _NovotellHotelCardState extends State<NovotellHotelCard> {
  late bool hover;
  @override
  void initState() {
    hover = false;
  ...
  final Hotel hotel = Hotel.hotels[2];
  @override
