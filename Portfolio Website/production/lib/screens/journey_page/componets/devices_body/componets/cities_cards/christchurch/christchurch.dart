...
class CristchurchCityCard extends StatefulWidget {
  @override
  _CristchurchCityCardState createState() => _CristchurchCityCardState();
}

class _CristchurchCityCardState extends State<CristchurchCityCard> {
  late bool hover;
  @override
  void initState() {
    hover = false;
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: Assets.christchurchCity.provider,
                      fit: BoxFit.cover,
                    ),
                  ),
                  child: Container(
